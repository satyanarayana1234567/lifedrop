...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">Life<span>Drop</span></a>
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto gap-1">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>"><i class="fas fa-home me-1"></i> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('donors.create')); ?>"><i class="fas fa-user-plus me-1"></i> Register Donor</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('donors.search')); ?>"><i class="fas fa-search me-1"></i> Find Donor</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('donors.index')); ?>"><i class="fas fa-list me-1"></i> Donor List</a>
                </li>
            </ul>
        </div>
    </div>
...
<footer>
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <ul style="list-style:none; padding:0;">
                    <li class="mb-2"><a href="<?php echo e(route('home')); ?>"><i class="fas fa-chevron-right me-2" style="font-size:11px; color:#ff8fa3"></i>Home</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('donors.create')); ?>"><i class="fas fa-chevron-right me-2" style="font-size:11px; color:#ff8fa3"></i>Register as Donor</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('donors.search')); ?>"><i class="fas fa-chevron-right me-2" style="font-size:11px; color:#ff8fa3"></i>Find Donor</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('donors.index')); ?>"><i class="fas fa-chevron-right me-2" style="font-size:11px; color:#ff8fa3"></i>All Donors</a></li>
                </ul>
            </div>
            <div class="col-md-4">
        ...
        <p class="text-center mb-0" style="color:rgba(255,255,255,0.45); font-size:13px;">
            © <?php echo e(date('Y')); ?> LifeDrop · Donate Blood, Save Lives · Built with love for humanity
        </p>
    </div>
</footer>
<?php endif; ?>
...
</html><?php /**PATH C:\Users\kamir\OneDrive\Desktop\Laravel Projects\lifedrop\resources\views/layouts/app.blade.php ENDPATH**/ ?>