    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="form-card reveal">
                ...
                <form action="{{ route('donors.store') }}" method="POST" enctype="multipart/form-data" id="donorForm">
                    @csrf
                    ...
                    <div class="row g-5 align-items-start">
                        ...
                        <div class="col-md-8">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field-icon-wrap">
                                            ...
                                            <input type="number" name="age" class="form-control"
                                                   placeholder="e.g. 25" min="18" max="65" value="{{ old('age') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="field-icon-wrap">
                                            ...
                                            <input type="text" name="phone" class="form-control"
                                                   placeholder="10-digit mobile" value="{{ old('phone') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="field-group">
                                ...
                                <input type="hidden" name="blood_group" id="bloodGroupInput" value="{{ old('blood_group') }}" required>
                                <div class="blood-grid" id="bloodGrid">
                                    @foreach(['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $group)
                                        <div class="blood-chip {{ old('blood_group') == $group ? 'selected' : '' }}"
                            ...
                            <input type="hidden" name="availability" id="availInput" value="{{ old('availability', 'Available') }}">
                            <div class="avail-toggle field-group">
                                <div class="avail-opt {{ old('availability','Available') == 'Available' ? 'selected-yes' : '' }}"
                                     id="availYes" onclick="setAvail('Available')">
                                    ✅ Available Now
                                </div>
                                <div class="avail-opt {{ old('availability') == 'Not Available' ? 'selected-no' : '' }}"
