...
<div class="page-hero">
    ...
    <div style="position:relative;z-index:2;">
        ...
        <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
            <div class="stat-chip">❤️ {{ $donors->count() }} Registered Donors</div>
...
<div class="container" style="padding: 56px 20px 80px;">
    ...
    @if($donors->count() > 0)
        <div class="row g-4" id="donorGrid">
            ...
            <div class="col-lg-4 col-md-6 reveal reveal-delay-{{ ($loop->index % 3) + 1 }}"
                 ...
                 data-city="{{ strtolower($donor->city) }}"
                 data-blood="{{ strtolower($donor->blood_group) }}">
                <div class="donor-card">
                    ...
                    <div class="donor-info">
                        ...
                        <div class="donor-info-row">
                            ...
                            <span><strong>Age:</strong> {{ $donor->age }} years</span>
                        </div>
                        <div class="donor-info-row">
                    ...
                    <!-- WhatsApp button -->
                    <a href="https://wa.me/91{{ $donor->phone }}?text=Hello%20{{ urlencode($donor->name) }},%20I%20found%20your%20contact%20on%20LifeDrop.%20Are%20you%20available%20for%20blood%20donation?"
    ...
    @else
        <div class="empty-state reveal">
            ...
            <a href="{{ route('donors.create') }}" class="btn btn-red btn-lg">
