...
<div id="page">
    ...
    <section class="hero-section">
        ...
        <div class="hero-inner">
            ...
            <div class="hero-btns">
                <a href="{{ route('home') }}" class="btn-primary-cta" onclick="navigate(event,this.href)">
                    <i class="fas fa-heart"></i> Let's Donate
                </a>
                <a href="{{ route('donors.search') }}" class="btn-ghost-cta" onclick="navigate(event,this.href)">
    ...
    <section class="section blood-types-section">
        <div class="section-inner">
            ...
            <div class="blood-grid">
                @foreach([['A+','Most common & in high demand'],['A−','Universal plasma donor'],['B+','3rd most common group'],['B−','Rare — very valuable'],['AB+','Universal recipient'],['AB−','Rarest of all types'],['O+','Most donated group'],['O−','Universal donor 🏆']] as $bt)
                <div class="blood-type-card reveal d{{ ($loop->index % 4) + 1 }}">
                    <div class="bt-group">{{ $bt[0] }}</div>
                    <div class="bt-label">{{ $bt[1] }}</div>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <div class="cta-band">
        <div class="reveal">
            ...
            <div class="cta-band-btns">
                ...
                <a href="{{ route('donors.create') }}" class="btn-ghost-cta" onclick="navigate(event,this.href)">
    ...
    <footer class="welcome-footer">
        ...
        <div class="footer-copy">© {{ date('Y') }} LifeDrop · Built with love for humanity · Every drop saves a life</div>
    </footer>
