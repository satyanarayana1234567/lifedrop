...
<section class="hero text-center">
    ...
    <div class="container hero-content">
        ...
        <div class="mt-5 d-flex justify-content-center gap-3 flex-wrap">
            ...
            <a href="{{ route('donors.search') }}" class="btn btn-light-custom btn-lg">
...
<div class="motivation-section reveal" style="text-align:center;">
    <div class="container">
        ...
        <a href="{{ route('donors.create') }}" class="btn btn-light-custom mt-5 btn-lg">
    ...
    if (score >= 4) {
        document.getElementById('resultBox').innerHTML = `
            <div class="result-box result-eligible">
                ...
                <a href="{{ route('donors.create') }}" class="btn btn-red mt-4">
